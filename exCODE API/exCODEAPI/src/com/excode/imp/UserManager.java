...
public class UserManager {
	...
	public static UserManager getInstance() {
		...
		if (userManager == null) {
			...
			User user1 = new User("andregouveia8", "porto", "asd@xpto.com", "André Gouveia");
			User user2 = new User("andregouveia9", "porto", "asd@xpto.com", "André Gouveia");
			User user3 = new User("paulo", "porto", "asd@xpto.com", "André Gouveia");
